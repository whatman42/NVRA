"""MT5-specific adapter."""

from __future__ import annotations

from pathlib import Path

from god.bridge.artifacts.registry import EA_NAME_MT5
...
class MT5Adapter:
    ...
    def normalize_terminal(self, terminal: TerminalInstance) -> TerminalInstance:
        ...
        if not experts and terminal.executable_path:
            ...
            experts = str(root / "MQL5" / "Experts")
        elif not experts and data:
            experts = str(Path(data) / "MQL5" / "Experts")
        return TerminalInstance.create(
            ...
            metadata={**terminal.metadata, "adapter": "MT5"},
        )
